...
# Default target
all: setup compile ptau_ppot_0080_23 gen_withdraw gen_cancelbet gen_update1 gen_update3 gen_update5 gen_update11 gen_update21 gen_update44 gen_update89 gen_update179 move
...
ptau_ppot_0080_23:
	@echo "download powers of tau ceremony..."
	cd $(ARTIFACTS_DIR) && \
...
gen_withdraw:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup withdraw.r1cs ppot_0080_23.ptau withdraw_final.zkey && \
...
gen_cancelbet:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup cancelbet.r1cs ppot_0080_23.ptau cancelbet_final.zkey && \
...
gen_update1:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup update1.r1cs ppot_0080_23.ptau update1_final.zkey && \
...
gen_update3:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup update3.r1cs ppot_0080_23.ptau update3_final.zkey && \
...
gen_update5:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup update5.r1cs ppot_0080_23.ptau update5_final.zkey && \
...
gen_update11:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup update11.r1cs ppot_0080_23.ptau update11_final.zkey && \
...
gen_update21:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup update21.r1cs ppot_0080_23.ptau update21_final.zkey && \
...
gen_update44:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup update44.r1cs ppot_0080_23.ptau update44_final.zkey && \
...
gen_update89:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup update89.r1cs ppot_0080_23.ptau update89_final.zkey && \
...
gen_update179:
	cd $(ARTIFACTS_DIR) && \
	snarkjs groth16 setup update179.r1cs ppot_0080_23.ptau update179_final.zkey && \
