...
contract Lottery {
    ...
    constructor(IWithdraw _Withdraw,ICancel _Cancel,IUpdate _Update,IERC20 _Token,uint _BetMin) {
        ...
        for(uint i=0;i<betsMax;i++){
            ...
            // 17788283807784131291671682947107953227960083346784294075013339262372341265415 root
            bets[i]=0x00ce413930404e34f411b5117deff2a1a062c27b1dba271e133a9ffe91eeae52; // sha256("foom")
        }
        roots[0] = 0x2753cfd5199dc55cf85933769e95affd5b112737e3b97540c74477322402b407;
